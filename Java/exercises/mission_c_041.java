  ...
  public static void main(String[] args) {
    ...
    while (checkFlg) {
      ...
      for (int j = 0; j < country - 1; j++) {
        ...
        if (getMedal[j][0] < getMedal[j + 1][0]
            || (getMedal[j][0] == getMedal[j + 1][0] && getMedal[j][1] < getMedal[j + 1][1])
            || (getMedal[j][0] == getMedal[j + 1][0] && getMedal[j][1] == getMedal[j + 1][1]
    ...
    for (int k = 0; k < country; k++) {
      System.out.println(Integer.toString(getMedal[k][0]) + " " + Integer.toString(getMedal[k][1]) + " "
          + Integer.toString(getMedal[k][2]));
    }
  }
}