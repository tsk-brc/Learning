...
class MissionB087
  def run
    ...
    if max_num_search(input_line[0], input_line[1], input_line[2], num_array,
true) > max_num_search(input_line[1], input_line[0], input_line[2], num_array,
false)
      puts max_num_search(input_line[0], input_line[1], input_line[2],
num_array, true)
    else
      puts max_num_search(input_line[1], input_line[0], input_line[2],
num_array, false)
    end
  end
end
